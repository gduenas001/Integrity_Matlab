...
% control noises
sigmaV= 0.3*8; % m/s ( default= 0.3 )
sigmaG= deg2rad(3*8); % radians ( default= (3.0*pi/180) )
...
SWITCH_ASSOCIATION= 3; % if 1, associations are given, if 0, they are estimated using gates
